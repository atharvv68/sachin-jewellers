export const TRANSLATIONS = {
  en: {
    ...
    taglineSubtitle: 'THE HOUSE OF FINE GEMSTONES',
    nav: {
      home: 'Home',
      catalogue: 'Catalogue',
      about: 'About Us',
      contact: 'Contact',
      gemstones: 'Gemstones / Ratna',
      gemstonesDesc: 'Natural certified precious & semi-precious stones',
      rudraksha: 'Sacred Rudraksha',
      rudrakshaDesc: '1 to 14 Mukhi beads, Siddh Malas & bracelets',
      kundali: 'Kundali Advisor',
    ...
    categories: {
      eyebrow: 'Vedic Taxonomy',
      heading: 'Explore Gemstone Categories',
      subheading:
        'Select from astrological Navratna, rare Upratna, healing semi-precious stones and organic pearls.',
      navratna: {
        title: 'Navratna (Precious)',
        desc: 'The nine primary Vedic planetary gemstones for astrological empowerment.',
        count: '9 Sacred Stones',
      },
      upratna: {
        title: 'Upratna (Secondary)',
        desc: 'Traditional planetary substitutes offering aligned energies and vibrant aesthetics.',
        count: '11 Astrological Substitutes',
      },
      semiPrecious: {
        title: 'Semi-Precious',
        desc: 'Healing crystals and naturally colored gemstones for balance and clarity.',
        count: '8 Balancing Stones',
      },
      pearlOrganic: {
        title: 'Pearl & Organic',
        desc: 'Natural sea pearls, Italian coral, and authentic organic mineral specimens.',
        count: '3 Organic Minerals',
      },
    },
    trustPillars: {
      eyebrow: 'Our Promise',
      ...
      cards: [
        ...
        {
          heading: 'Direct Sourcing & Fair Pricing',
          body: 'We source directly from trusted mining families and gem cutters in Burma, Ceylon, Zambia and India to offer honest value.',
        },
        {
          heading: 'Vedic Energisation (Pran Pratishtha)',
          body: 'Each stone is purified and consecrated with Vedic mantras according to your horoscope and planetary alignment.',
        },
        {
    ...
    rudrakshaSpotlight: {
      ...
      consultBtn: 'Consult on WhatsApp',
    },
    ownerTeaser: {
    ...
    catalogue: {
      ...
      consultWa: 'Consult on WhatsApp',
      secondaryHeading: 'More Sacred Collections & Traditional Articles',
      secondarySubheading:
        'Authentic handcrafted puja essentials, yantras, silver lockets and devotional articles.',
      hideSecondary: 'Hide Additional Collections',
      showSecondary: 'Explore Additional Collections',
      moreCollections: {
  ...
  hi: {
    langName: 'EN',
    brand: 'सचिन ज्वैलर्स',
    taglineSubtitle: 'द हाउस ऑफ फाइन जेमस्टोन्स',
    nav: {
      home: 'होम',
      catalogue: 'कैटलॉग',
      about: 'हमारे बारे में',
      contact: 'संपर्क करें',
      gemstones: 'रत्न (Gemstones)',
      gemstonesDesc: 'प्राकृतिक प्रमाणित नवरत्न व उपरत्न',
      rudraksha: 'पवित्र रुद्राक्ष',
      rudrakshaDesc: '१ से १४ मुखी दाने, सिद्ध माला व ब्रेसलेट',
      kundali: 'कुंडली सलाहकार',
    ...
    categories: {
      eyebrow: 'वैदिक वर्गीकरण',
      heading: 'रत्न श्रेणियों का अन्वेषण करें',
      subheading:
        'ज्योतिषीय नवरत्न, दुर्लभ उपरत्न, हीलिंग सेमी-प्रेशियस रत्न एवं प्राकृतिक मोती चुनें।',
      navratna: {
        title: 'नवरत्न (प्रमुख रत्न)',
        desc: 'नौ प्रमुख वैदिक ग्रहीय रत्न जो ग्रहों की सकारात्मक ऊर्जा को सुदृढ़ करते हैं।',
        count: '९ पवित्र रत्न',
      },
      upratna: {
        title: 'उपरत्न (सहायक रत्न)',
        desc: 'पारंपरिक ग्रहीय विकल्प जो प्रभाव और सौंदर्य दोनों में श्रेष्ठ हैं।',
        count: '११ ज्योतिषीय उपरत्न',
      },
      semiPrecious: {
        title: 'सेमी-प्रेशियस स्टोन',
        desc: 'मानसिक शांति, हीलिंग और ऊर्जा संतुलन के लिए प्राकृतिक रंगीन रत्न।',
        count: '८ संतुलन रत्न',
      },
      pearlOrganic: {
        title: 'मोती एवं जैविक रत्न',
        desc: 'समुद्री प्राकृतिक मोती, इटालियन मूँगा एवं दुर्लभ जैविक रत्न।',
        count: '३ जैविक खनिज',
      },
    },
    trustPillars: {
      ...
      cards: [
        ...
        {
          heading: 'सीधा स्रोत एवं उचित मूल्य',
          body: 'बर्मा, सीलोन, जाम्बिया और भारत के विश्वसनीय खदान परिवारों से सीधे खरीद, बिना किसी बिचौलिए के।',
        },
        {
          heading: 'वैदिक प्राण प्रतिष्ठा',
          body: 'आपकी कुंडली और ग्रह स्थिति के अनुसार वैदिक विधि-विधान और मंत्रोच्चार से ऊर्जावान किया जाता है।',
        },
        {
    ...
    rudrakshaSpotlight: {
      ...
      consultBtn: 'व्हाट्सएप पर परामर्श लें',
    },
    ownerTeaser: {
    ...
    catalogue: {
      ...
      consultWa: 'व्हाट्सएप पर परामर्श लें',
      secondaryHeading: 'अन्य पारंपरिक एवं पूजा संग्रह',
      secondarySubheading:
        'प्रामाणिक पूजा सामग्री, सिद्ध यंत्र, चांदी के लॉकेट एवं भक्ति सामग्री।',
      hideSecondary: 'अतिरिक्त संग्रह छिपाएँ',
      showSecondary: 'अतिरिक्त संग्रह देखें',
      moreCollections: {
        eyebrow: 'अन्य संग्रह',
